...
function demarrerLaMontre() {
  var date = new Date(); //Stocker l'heure , minute , seconde  dans des varaiables

  var hr = date.getHours();
  var min = date.getMinutes();
  var sec = date.getSeconds(); // Calculer de degré de mouvement de l'aiguille heure, de l'aiguille minute, de l'aiguille seconde
  ...
  AIGUILLEHR.style.transform = "rotate(".concat(hr * 360 / 12 + min * 30 / 60, "deg)");
  AIGUILLEMIN.style.transform = "rotate(".concat(min * 360 / 60 + sec * 6 / 60, "deg)");
  AIGUILLESEC.style.transform = "rotate(".concat(sec * 360 / 60, "deg)");
